...
или для существующего пользователя `/sign-in`
...
Для создания баннера необходимо отправить POST запрос на `/banner`
